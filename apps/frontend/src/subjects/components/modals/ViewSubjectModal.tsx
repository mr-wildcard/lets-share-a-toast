...
import SubjectSpeakers from 'frontend/subjects/components/list/item/SubjectSpeakers';
import SubjectInfoBadges from 'frontend/subjects/components/modals/SubjectInfoBadges';
